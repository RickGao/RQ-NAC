...
Primary dataset:
https://www.kaggle.com/datasets/mdfahimbinamin/100k-vehicle-dashcam-image-dataset/data
...
Some of these codes have already been copied to:

nac/data/

renamed accordingly, and can be directly used by NAC
